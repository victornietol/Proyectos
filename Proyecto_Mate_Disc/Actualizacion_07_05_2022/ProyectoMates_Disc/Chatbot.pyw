...
class Chatbot:
    ...
    def clasificacion_pregunta(self,x):
        if (('esta' in x) and ('clima' in x)) or ('clima' in x) or ('temperatura' in x):
            ...
            if self.pregunta_aux == 'netflix':
                ...
                preg = input(f'{self.dialogo} Puedo mostrarte peliculas de acción de Netflix y HBO Max, ¿Cuál prefieres?.\nTú: ')
                if preg.__contains__('netflix'):
                    x = 'accion_netflix'
                elif preg.__contains__('hbo'):
                    x = 'accion_hbo'
            ...
            if self.pregunta_aux == 'netflix':
                x = 'pel_cat_netflix'
                #self.pregunta_aux = 'pel_cat_netflix' # 'pel_cat_netflix'
            elif self.pregunta_aux == 'hbo':
                x = 'pel_cat_hbo'
                #self.pregunta_aux = 'pel_cat_hbo'  # 'pel_cat_hbo'
            elif self.pregunta_aux == 'disney+':
                x = 'cat_disney'
                #self.pregunta_aux = 'cat_disney'  # 'cat_disney'
    ...
    def interfaz(self):
        ...
        self.v_frame = tk.Frame(self.ventana,width='500', height='650', bg='white')
        ...
        img = Image.open('imagenes/enviar222.png')
        ...
        # boton enviar
        self.boton_enviar = ttk.Button(self.v_frame2, image=img, cursor='hand2').place(x=430,y=7)      # Op. 1
