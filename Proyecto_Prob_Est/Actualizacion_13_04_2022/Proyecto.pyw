...
class Interfaz:
    def __init__(self):
        ...
        self.entry_edad.bind('<Return>', self.sugerencia)
        ...
        self.entry_temp.bind('<Return>', self.sugerencia)
    ...
    def sugerencia(self, event=None):
    ...
    def codigo_github(self):
        import webbrowser
        webbrowser.open('https://github.com/victornietol/Proyectos/blob/main/Proyecto_Prob_Est/Actualizacion_13_04_2022/Proyecto.py')
