...
class Convertidor:
    def __init__(self,numEstados):
        ...
        self.nuevoAutomata = {}
        self.transiciones = []   # tal vez quitar (Son los valores de las transiciones)
        self.claves = []
        self.nuevasValoraciones = [["q0"]] # siempre se inicia con q0
        ...
        #print(self.automataOriginal)
        
  
    def agregar_estado(self,estado,transicion,conectaCon):
        self.transiciones.append(transicion)   # quitar si no se usan transciones
    ...
    def valorarEstados(self,estados):
                ...
                for e in estados:   # valoracion con "a"
                    ...
                    for elem in valAct:
                        if(elem in resultado):  
                            ...
                            resA.append(elem)
                        #nVal = self.automataOriginal[e][tran]
        ...
        """
        continuar con el guardado de las nuevas evaluaciones (nuevos q generados)
        
                 
        print("hechas: ",self.valoracionesHechas)
        #print("nuevas: ",self.nuevasValoraciones)
        prubaV = list(self.nuevosEstados.keys())
        print("nuevos estados: ")
        for vertices in prubaV: 
            print(vertices," | ",self.nuevosEstados[vertices])
        """   
    ...
    def obtener_valAB(self,estado):
        ...
        for e in estadosE:      # encontrando coincidencia en tabla equivalencias
            #print(f"estadoEquivalencia: {e} | valorDelNEstado: {valor} | equiv: {self.equivalencias[e]}")
